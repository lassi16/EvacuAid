...
export default function TasksPage() {
  ...
  const mapLinkedTasks = tasks.filter(
    (t) => incidents.find((i) => i.id === t.incidentId)?.mapLinked,
  ).length;
  ...
  return (
    <div className="space-y-4 flex flex-col h-full min-w-0">
      ...
      >
        ...
        {(
          ["all", "New", "In Progress", "Acknowledged", "Resolved"] as (
            | TaskStatus
            | "all"
          )[]
        ).map((s) => (
          <button
            ...
            style={{
              ...
              cursor: "pointer",
              background:
                filterStatus === s ? "rgba(14,165,233,0.15)" : "transparent",
        ...
        <div
          style={{ width: 1, height: 18, background: "rgba(14,165,233,0.2)" }}
        />
        {(
          ["all", "High", "Medium", "Low"] as (
            | "all"
            | "High"
            | "Medium"
            | "Low"
